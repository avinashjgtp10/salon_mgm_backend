...
// Mounted at /api/v1/reports in app.ts — kept alongside the newer
// independent POST /api/report/* endpoints (reports.routes.ts) rather than
// removed, since other pages/branches may still depend on these paths.
// ======================================================
