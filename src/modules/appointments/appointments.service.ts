...
export const appointmentsService = {
    ...
    async confirm(appointmentId: string): Promise<Appointment> {
        ...
        const updated = await appointmentsRepository.updateStatus(appointmentId, "confirmed");
        emitSalonEvent("appointments:updated", existing.salon_id, updated.id, "updated", updated);
        return updated;
    },
    ...
    async start(appointmentId: string): Promise<Appointment> {
        ...
        const updated = await appointmentsRepository.updateStatus(appointmentId, "in_progress");
        emitSalonEvent("appointments:updated", existing.salon_id, updated.id, "updated", updated);
        return updated;
    },
    ...
    async noShow(appointmentId: string): Promise<Appointment> {
        ...
        const updated = await appointmentsRepository.updateStatus(appointmentId, "no_show");
        emitSalonEvent("appointments:updated", existing.salon_id, updated.id, "updated", updated);
        return updated;
    },
