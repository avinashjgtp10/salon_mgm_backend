...
router.post("/", auth_middleware_1.authMiddleware, (0, role_middleware_1.roleMiddleware)("salon_owner", "admin"), salons_validator_1.validateCreateSalon, salons_controller_1.salonsController.create);
router.get("/me", auth_middleware_1.authMiddleware, (0, role_middleware_1.roleMiddleware)("salon_owner", "admin"), salons_controller_1.salonsController.mySalon);
