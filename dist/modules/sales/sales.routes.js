...
router.get("/export", auth_middleware_1.authMiddleware, (0, role_middleware_1.roleMiddleware)("salon_owner", "admin", "staff"), sales_controller_1.salesController.exportSales);
