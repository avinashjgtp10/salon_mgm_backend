...
const dashboard_routes_1 = __importDefault(require("./modules/marketing/whatsapp/dashboard/dashboard.routes"));
const templates_routes_1 = __importDefault(require("./modules/marketing/whatsapp/templates/templates.routes"));
const campaigns_routes_1 = __importDefault(require("./modules/marketing/whatsapp/campaigns/campaigns.routes"));
const config_routes_1 = __importDefault(require("./modules/marketing/whatsapp/config/config.routes"));
const webhooks_routes_1 = __importDefault(require("./modules/marketing/whatsapp/webhooks/webhooks.routes"));
...
app.use('/api/v1/campaigns', campaigns_routes_1.default);
app.use('/api/v1/wa-config', config_routes_1.default);
